# Evaluation: SpotDraft — Software Development Engineer - III
...
| **TL;DR** | Backend SDE3 owning scalable, high-performance systems with emphasis on architecture, mentoring, and system design depth. |
...
**Domain-Specific Fit:**
Refer to cv.md for detailed proof points aligned with Backend SDE3 (System Design Focus).
...
**This Role:** SDE3 (7-10 yrs backend, mid-level: L4/L5)
**Fit:** APPLY
...
**Company:** SpotDraft
**Note:** Research separately on Glassdoor, Levels.fyi, or Blind for SpotDraft-specific data.
