# Evaluation: WEX — Software Development Engineer - 3
...
| **TL;DR** | Backend-focused SDE3 designing scalable payment systems for fleet/mobility with Java, Spring Boot, and distributed tech. |
...
**Domain-Specific Fit:**
Refer to cv.md for detailed proof points aligned with Backend SDE3 (Payments/Financial Systems).
...
**This Role:** SDE3 (5-8 yrs backend, mid-level: L4)
**Fit:** APPLY
...
**Company:** WEX
**Note:** Research separately on Glassdoor, Levels.fyi, or Blind for WEX-specific data.
